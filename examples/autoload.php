...
$s5f4f912b96808__arrautoloadCustomCommon = [
...
$s5f4f912b96808__arrautoloadCommon = [
...
$s5f4f912b96808__arrautoloadAbsolute = [
 ...
 * @throws Exception
 */
function s5f4f912b96808__auto($class_name)
{
    ...
    // special cases
    if (isset($GLOBALS['s5f4f912b96808__arrautoloadCustom'][$class_name])) {
        s5f4f912b96808__loadIfExists($GLOBALS['s5f4f912b96808__arrautoloadCustom'][$class_name]
            , $class_name,'s5f4f912b96808__arrautoloadCustomCommon');
        return;
    }
    // normal (folder) cases
    if (isset($GLOBALS['s5f4f912b96808__arrautoload'][$ns])) {
        s5f4f912b96808__loadIfExists($GLOBALS['s5f4f912b96808__arrautoload'][$ns] . '/' . $cls . '.php'
            , $ns,'s5f4f912b96808__arrautoloadCommon');
        return;
    }
}
 ...
 * @throws Exception
 */
function s5f4f912b96808__loadIfExists($filename, $key,$arrayName='')
{
    if (isset($GLOBALS['s5f4f912b96808__arrautoloadAbsolute'][$key])) {
        ...
        $fullFile = __DIR__ . '/' . s5f4f912b96808__replaceCurlyVariable($filename, $arrayName); // its relative to this path
    }
    /** @noinspection PhpIncludeInspection */
    if ((@include $fullFile) === false) {
        if ($GLOBALS['s5f4f912b96808__debug']) {
...
function s5f4f912b96808__replaceCurlyVariable($string,$arrayName) {
...
spl_autoload_register(static function ($class_name) {
    s5f4f912b96808__auto($class_name);
});
