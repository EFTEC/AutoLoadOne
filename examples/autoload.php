...
$s5eda56e1dbf7a__arrautoloadCustomCommon = [
...
$s5eda56e1dbf7a__arrautoloadCommon = [
...
$s5eda56e1dbf7a__arrautoloadAbsolute = [
 ...
 * @throws Exception
 */
function s5eda56e1dbf7a__auto($class_name)
{
    ...
    // special cases
    if (isset($GLOBALS['s5eda56e1dbf7a__arrautoloadCustom'][$class_name])) {
        s5eda56e1dbf7a__loadIfExists($GLOBALS['s5eda56e1dbf7a__arrautoloadCustom'][$class_name]
            , $class_name,'s5eda56e1dbf7a__arrautoloadCustomCommon');
        return;
    }
    // normal (folder) cases
    if (isset($GLOBALS['s5eda56e1dbf7a__arrautoload'][$ns])) {
        s5eda56e1dbf7a__loadIfExists($GLOBALS['s5eda56e1dbf7a__arrautoload'][$ns] . '/' . $cls . '.php'
            , $ns,'s5eda56e1dbf7a__arrautoloadCommon');
        return;
    }
}
 ...
 * @throws Exception
 */
function s5eda56e1dbf7a__loadIfExists($filename, $key,$arrayName='')
{
    if (isset($GLOBALS['s5eda56e1dbf7a__arrautoloadAbsolute'][$key])) {
        ...
        $fullFile = __DIR__ . '/' . s5eda56e1dbf7a__replaceCurlyVariable($filename, $arrayName); // its relative to this path
    }
    /** @noinspection PhpIncludeInspection */
    if ((@include $fullFile) === false) {
        if ($GLOBALS['s5eda56e1dbf7a__debug']) {
...
function s5eda56e1dbf7a__replaceCurlyVariable($string,$arrayName) {
...
spl_autoload_register(static function ($class_name) {
    s5eda56e1dbf7a__auto($class_name);
});
// autorun
